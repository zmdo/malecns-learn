...
| **MaleCNS v1.0（2026）** | **雄蝇全 CNS** | 脑中 + 视叶 + VNC（含完整颈连接） | **8 nm 各向同性**（发布体）；成像方式 FIB-SEM（同一标本的视叶论文口径） | **166,691 个神经元**、**11,691 个类型**（预印本口径；正式版为 166,700 / 11,710） | Codex 默认 5+ 阈值下 **6,242,118 条连接**；突触总数 **124,177,617**（神经元子图，2026-09-20 复核坐实） | 见第 0 节 |
