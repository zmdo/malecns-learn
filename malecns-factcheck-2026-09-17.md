...
| 有向连接数 | 25,582,938 | **待核实**。官方作者提供的计数 notebook（v0.9 口径）：未阈值 **25,563,426** 条边（166,391 个有 superclass 的神经元）；≥5 突触阈值下 **6,237,402** 条边；Codex MCNS v1.0 显示 **6,242,118** connections | **待核实** |
| 突触接触数 | 124,177,617 | **待核实（整数）**。Science 新闻明确 "**124.2 million synapses**"；UKRI 新闻 "**124 million synaptic connections**" | **待核实（量级确认）** |
...
| 声明 | 结论 | 关键修正 |
|---|---|---|
| A 规模 | **修正** | 166,700 是**正式发表+Codex**数字，非「社区过滤」；25,582,938 与 124,177,617 整数**待核实**（官方口径 25,563,426 / 124.2M） |
