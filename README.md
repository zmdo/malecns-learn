...
| # | 论文 | 开放获取 | 段落 | 译文 |
|---|---|---|---|---|
| 01 | **Berg et al.** MaleCNS 主论文（bioRxiv 预印本 v2, 2025-10-30） | ✅ CC-BY 4.0 | 200 | ✅ 100% |
| 02 | Dorkenwald et al. 2024, *Nature* 634:124–138 | ✅ CC-BY | 134 | ✅ 100% |
| 03 | Shiu et al. 2024, *Nature* 634:210–219 | ✅ CC-BY | 82 | ✅ 100% |
| | **合计** | | **416** | **✅ 100%** |

> **关于 Berg 那篇的口径**：Cell 正式版（2026-09）是订阅制，不能转载；
> 因此正文取自 **bioRxiv 预印本（CC-BY 4.0）**。
